...
# -*- coding: utf-8 -*-
"""
Анализ ограничений оригинального запроса
Изучаем какие товары попадают под STORGRPID и CSDTKTHBID
"""
...
def analyze_query_constraints():
    """Анализирует ограничения оригинального запроса"""
    try:
...
def main():
    ...
    sales_data, group_data = analyze_query_constraints()
