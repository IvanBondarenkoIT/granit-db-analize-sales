...
# -*- coding: utf-8 -*-
"""
Финальное тестирование правильной логики расчета веса
"""
...
def test_final_weight_logic():
    """Финальное тестирование логики расчета веса"""
    try:
        with DatabaseConnector() as db:
            print("=== ФИНАЛЬНОЕ ТЕСТИРОВАНИЕ ЛОГИКИ РАСЧЕТА ВЕСА ===")
...
def compare_with_verification_simple(coffee_data):
    """Простое сравнение с эталонными данными"""
    print("\n=== СРАВНЕНИЕ С ЭТАЛОННЫМИ ДАННЫМИ ===")
    
    # Эталонные данные (из предыдущего анализа)
    verification_data = {
...
def main():
    ...
    coffee_data = test_final_weight_logic()
    ...
    compare_with_verification_simple(coffee_data)
